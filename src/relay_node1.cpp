...
int main(){
    ...
    log_event("relay1", "connection_accepted");
    ...
    log_event("relay1", "decrypt_start");
    ...
    log_event("relay1", "auth_success");
    log_event("relay1", "forwarding_to_next");
